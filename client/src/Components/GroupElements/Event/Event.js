  ...
  return (
    ...
    <Link to={props.link}>
      ...
      <div className="card bg-gray-200 rounded-lg overflow-hidden shadow-md flex mt-2 mx-1 hover:bg-gray-300 w-full">
        ...
        />
        <div className="p-4">
          <h3 className="text-sm font-semibold mb-2">{props.eventName}</h3>
          <h3 className="text-sm font-semibold mb-2">Date: <span className="font-normal">{props.date}</span></h3>
          <h3 className="text-sm font-semibold mb-2">Location: <span className="font-normal">{props.location}</span></h3>
        </div>
      </div>
    </Link>
    {/* <style>
